...
from model import create_final_model, TeacherModel
...
class TrainingLogger:
    ...
    def __init__(self, log_dir, model=None):
        ...
        with open(self.log_file, 'w') as f:
            ...
            f.write(f"Dropout: {BEST_DROPOUT}\n")
            f.write(f"Seed: {SEED}\n")
            f.write("="*80 + "\n\n")
...
def main():
    ...
    if args.distill:
        ...
        if args.finetuned_teacher:
            teacher_model = TeacherModel(num_classes=8, pretrained=False)
            print("Loading finetuned teacher model weights...")
            checkpoint = torch.load("/home/gasbert/master/C3/project-team-3/Week3/checkpoints/best_model_fold_1.pth", map_location="cpu", weights_only=False)
